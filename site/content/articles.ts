...
const coliques: Article = {
  ...
  readingTime: 7,
  titleDisplay: {
    fr: "Coliques, heure du sorcier, deuxième soir",
    en: "Colic, witching hour, second night",
    zh: "肠绞痛、魔女时刻、第二个晚上",
    it: "Coliche, ora delle streghe, seconda notte",
  },
  titleSub: {
    fr: "comment ne pas tout confondre.",
    en: "how not to mix them up.",
    zh: "如何区分这三种截然不同的现实。",
    it: "come non confonderle.",
  },
  excerpts: {
